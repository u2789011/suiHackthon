...
const BasicContainer = () => {
  ...
  const DEVNET_EXPLORE = "https://suiscan.xyz/testnet/tx/"; //TODO: changed env to testnet
  const DEVNET_EXPLOR_OBJ = "https://suiscan.xyz/testnet/object/"; //TODO: changed env to testnet
